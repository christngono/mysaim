  ...
  return (
    <div className="bg-white">
      <TextParallaxContent
        ...
        subheading="Collaborez"
        heading="Conçu pour tous."
      >
        <ExampleContent />
      </TextParallaxContent>
      <TextParallaxContent
      ...
      <TextParallaxContent
        ...
        subheading="Moderne"
        heading="Apprenez avec les meilleurs."
      >
        <ExampleContent />
      </TextParallaxContent>
    </div>
...
const ExampleContent = () => (
  <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-4 pb-24 pt-12 md:grid-cols-12">
    <h2 className="col-span-1 text-3xl font-bold md:col-span-4">
      Contenu additionnel expliquant la section ci-dessus
    </h2>
    <div className="col-span-1 md:col-span-8">
      <p className="mb-4 text-xl text-neutral-600 md:text-2xl">
        SAIM est la première plateforme camerounaise de formation à l'intelligence artificielle.
        Nos modules sont conçus pour vous accompagner pas à pas, de la découverte de l'IA
        jusqu'à la maîtrise des outils les plus avancés.
      </p>
      <p className="mb-8 text-xl text-neutral-600 md:text-2xl">
        Rejoignez des centaines d'apprenants qui transforment déjà leur quotidien professionnel
